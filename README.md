...
module "terraform-module-digitalocean-mongodb" {
  ...
  replica_cluster_name    = "example-mongodb-replica-cluster"
  replica_region          = "nyc1"
...
| <a name="input_replica_node_size"></a> [replica\_node\_size](#input\_replica\_node\_size) | The mongodb replica node instance size. | `string` | `"db-s-1vcpu-1gb"` | no |
